...
public class GuiFreezer extends GuiContainer
{
    ...
    public GuiFreezer(InventoryPlayer par1InventoryPlayer, TileEntityFreezer par2TileEntityFreezer)
    {
        ...
        this.furnaceInventory = par2TileEntityFreezer;
    }
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Freezer"), 60, 6, 4210752);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/Reactioncraft/images/gui/freezer.png");
