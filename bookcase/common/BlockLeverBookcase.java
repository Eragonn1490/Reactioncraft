...
{
    protected BlockLeverBookcase(int par1, int par2)
    {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        if (var5 == 1)
        {
            ...
            //(0.0F, 0.2F, 0.5F - var6, var6 * 2.0F, 0.8F, 0.5F + var6)
            ;
        ...
        else if (var5 == 2)
        {
            this.setBlockBounds
            (0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F)
            //(1.0F - var6 * 2.0F, 0.2F, 0.5F - var6, 1.0F, 0.8F, 0.5F + var6)
            ;
        }
        else if (var5 == 3)
        {
            this.setBlockBounds
            (0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F)
            //(0.5F - var6, 0.2F, 0.0F, 0.5F + var6, 0.8F, var6 * 2.0F)
            ;
        }
        else if (var5 == 4)
        {
            this.setBlockBounds
            (0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F)
            //(0.5F - var6, 0.2F, 1.0F - var6 * 2.0F, 0.5F + var6, 0.8F, 1.0F)
            ;
        }
        else if (var5 != 5 && var5 != 6)
        {
            if (var5 == 0 || var5 == 7)
            {
                ...
                this.setBlockBounds
                (0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F)
                //(0.5F - var6, 0.4F, 0.5F - var6, 0.5F + var6, 1.0F, 0.5F + var6)
                ;
            }
        }
        else
        {
            ...
            this.setBlockBounds
            (0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F)
            //(0.5F - var6, 0.0F, 0.5F - var6, 0.5F + var6, 0.6F, 0.5F + var6)
            ;
        }
    }
