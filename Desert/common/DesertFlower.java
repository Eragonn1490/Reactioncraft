...
{
    public DesertFlower(int par1, int par2, Material par3Material)
    {
        super(par1, par2);
    ...
    public DesertFlower(int par1, int par2)
    {
    ...
    {
        return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == RCBDM.DarkSand.blockID|| par1 == Block.tilledField.blockID;
    }
