...
public class BlockGingerplant extends BlockFlower
{
    public BlockGingerplant(int par1, int par2)
    {
        super(par1, par2);
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if (metadata == 7)
        {
            ret.add(new ItemStack(RCHRM.GingerRoot));
        }
    ...
    {
        return par1 == 7 ? RCHRM.GingerRoot.shiftedIndex : -1;
    }
