...
public class BasicFlower extends BlockFlower implements IPlantable
{
    public BasicFlower(int par1, int par2, Material par3Material)
    {
        super(par1, par2);
    ...
    public BasicFlower(int par1, int par2)
    {
