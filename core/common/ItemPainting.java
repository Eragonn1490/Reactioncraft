...
public class ItemPainting extends Item
{
    ...
    public ItemPainting(int par1, Class par2Class)
    {
        super(par1);
    ...
    {
        return (EntityHanging)(this.hangingEntityClass == ReactioncraftEntityPainting.class ? new ReactioncraftEntityPainting(par1World, par2, par3, par4, par5) : (this.hangingEntityClass == EntityItemFrame.class ? new EntityItemFrame(par1World, par2, par3, par4, par5) : null));
    }
}
