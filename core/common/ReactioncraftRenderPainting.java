...
public class ReactioncraftRenderPainting extends RenderPainting
{
    public void renderThePainting(ReactioncraftEntityPainting par1ReactioncraftEntityPainting, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        GL11.glTranslatef((float)par2, (float)par4, (float)par6);
        GL11.glRotatef(par8, 0.0F, 1.0F, 0.0F);
        GL11.glEnable(GL12.GL_RESCALE_NORMAL);
        this.loadTexture("/Reactioncraft/images/art/kz.png");
        ReactioncraftEnumArt var10 = par1ReactioncraftEntityPainting.art;
        float var11 = 0.0625F;
        GL11.glScalef(var11, var11, var11);
        this.func_77010_a(par1ReactioncraftEntityPainting, var10.sizeX, var10.sizeY, var10.offsetX, var10.offsetY);
        GL11.glDisable(GL12.GL_RESCALE_NORMAL);
        GL11.glPopMatrix();
    }

    private void func_77010_a(ReactioncraftEntityPainting par1ReactioncraftEntityPainting, int par2, int par3, int par4, int par5)
    {
        ...
        for (int var21 = 0; var21 < par2 / 16; ++var21)
        {
            for (int var22 = 0; var22 < par3 / 16; ++var22)
            {
                ...
                this.func_77008_a(par1ReactioncraftEntityPainting, (var23 + var24) / 2.0F, (var25 + var26) / 2.0F);
    ...
    private void func_77008_a(ReactioncraftEntityPainting par1ReactioncraftEntityPainting, float par2, float par3)
    {
        int var4 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posX);
        int var5 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posY + (double)(par3 / 16.0F));
        int var6 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posZ);

        if (par1ReactioncraftEntityPainting.hangingDirection == 2)
        {
            var4 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posX + (double)(par2 / 16.0F));
        }

        if (par1ReactioncraftEntityPainting.hangingDirection == 1)
        {
            var6 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posZ - (double)(par2 / 16.0F));
        }

        if (par1ReactioncraftEntityPainting.hangingDirection == 0)
        {
            var4 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posX - (double)(par2 / 16.0F));
        }

        if (par1ReactioncraftEntityPainting.hangingDirection == 3)
        {
            var6 = MathHelper.floor_double(par1ReactioncraftEntityPainting.posZ + (double)(par2 / 16.0F));
        }
    ...
    {
        this.renderThePainting((ReactioncraftEntityPainting)par1Entity, par2, par4, par6, par8, par9);
    }
}
